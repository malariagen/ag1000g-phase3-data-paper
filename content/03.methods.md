...
Ag1000G phase mosquitoes, from natural populations, were collected at 124 sites (unique latitude/longitudes) in 19 sub-Saharan African countries (Figure 1; Supplemental Table @@??). 

95 of these sites are novel to phase 3, including 19 sites in six newly sampled countries, the remainder were previously sampled in phases 1 and 2 of the project (@doi.org/10.1038/nature24995; @@phase 2 doi when published).
...
Phase 3 adds collections from three novel site on the island of Mayotte. 
...
**Gabon** @@was this submission included in the release?? I can't see it in the meta data, delete?
...
Libreville is the capital of the country and it is urban and polluted site, malaria is endemic across the year.

The specimens were stored in alcohol at -20°C.

Finally, Cocobeach is a coastal village north of Libreville, malaria is endemic across the year.
...
In the first, collections were made in four villages in the Koulikoro region; Tieneguebougou (12.810, -8.080) approximately 20km north of Bamako, 
...
In Uganda, a new site is sampled in phase 3.
...
15@@? crosses were contributed to Ag1000G phase 1: @@... 

The labels, e.g. “29-2”, are identifiers used for each of the crosses within the project and have no special meaning. 

The crosses were generated using parents from seven different colonies: G3(MRA-112); Kisumu(MRA-762); Pimperena (canonical representative of _An. gambiae_ species; MRA-861); Ghana (recent colony of _An. coluzzii_ from Okyereko, southern Ghana (@doi:10.1371/journal.pgen.1004236)); Mali-NIH (canonical representative of _An. coluzzii_ species; Niono, MRA-860); (P)Akron (Benin, MRA-913); and Tiassalé (southern Cote d’Ivoire (@doi:10.1371/journal.pgen.1004236)).

Full details of cross production, sequencing and quality control is described in the Supplementary Information of The Anopheles gambiae 1000 Genomes Consortium (@doi.org/10.1038/nature24995).
