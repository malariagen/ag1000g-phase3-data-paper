...
Alongside sampling from natural populations, 699 individuals (@@?? meta data??)(parents and offspring) from 15 lab crosses have been sequenced.

Five of these crosses are novel to phase 3, adding power to measure the quality of wild sample variation and methods validation more generally.
