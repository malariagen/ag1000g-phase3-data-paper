...
The third and final phase of the Ag1000g project releases wild-caught _Anopheles_ mosquito genomes collected from a total of 124 sites across 19 countries in Sub-Saharan Africa.

Six novel countries have been sampled in phase 3; Malawi increases the density of coverage in West Africa, Central African Republic and Democratic Republic of Congo begin to fill the gap previously present in Central Africa while Malawi, Mozambique and Tanzania provide more power to analyse East African populations.

With improved quality control and filtering pipelines developed in this phase, all @nn samples submitted across all three project phases were evaluated with these new methods.
...
181 samples from phase 2 did not pass the new quality thresholds and are not included in this data release in this release (@@ either - see Supplementary table or explain 172 were lost via FILTER_second_rep_hi_skew <- what is this?).

Alongside sampling from natural populations, @@nn individuals (parents and offspring) from @@nn lab crosses have been sequenced.

@@nn of these crosses are novel to phase 3.
