...
All 5 evaluation pedigrees showed a small reduction in FDR, but coupled with the lower rate of accessibility in phase 2 (62.05%) resulted in an significant improvement in Youden score (Table XXX) 
...
Pre-application of the site filters, subject to a Genotype Quality (GQ) threshold of 30, the median heterozygosity rate was 0.44%, and post filtering this drops to 0.12% (table XX).

The median fold change in error rate was -1.74, with 69.97% of the X chromosome passing site filters.

Directly comparing the numbers to the phase 2 site filters, across the same pedigrees, we observe similar levels of mendelian error and X heterozygosity, however the updated site filters have a substantially higher sensitivity, yielding a higher Youden score over all crosses and chromosomes (Table Q).
