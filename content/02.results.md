...
Phase 3 of the Ag1000g project saw DNA extracted from wild-caught _Anopheles_ mosquitoes submitted to the Ag1000G consortium by partners in 27 sets, resulting in 2784 unique individual whole genome sequences. 1823 of these individuals are novel to phase 3, 181...


...talk about headline numbers first - all countries, sites, samples then explain how many are new?
...need to mention that P2 is not subset of P3 due to new sex filtering pipeline, some p2 are lost - how many?
